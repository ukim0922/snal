...
<div id="wrapper">
		...
		<div id="page" class="container">
				...
				<form  name="board_form" method="post" action="notice.php?table=<?=$table?>&mode=search"> 
				<div id="list_search">
		...
		?>
   						...
   						<tbody>
   							<tr>
        						...
        						<td id="list_item2"><a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><?= $item_title?></a></td>
		...
		?>			
					&nbsp;&nbsp;&nbsp;&nbsp;다음 ▶
						...
						<div id="button">
							<a href="notice.php?table=<?=$table?>&page=<?=$page?>" class="button">목록</a>&nbsp;
		<?php
		if(isset($_SESSION['user_session'])){
			if($_SESSION['user_session']=="admin"){
		?>
				<a href="write_form.php?table=<?=$table?>&mode=0" class="button">글쓰기</a>
		<?php
			}}
		?>
						</div>
