...
if(isset($_POST['btn-modify']))
{
	...
	if(!preg_match("/^01[0-9]{8,9}$/", $uphone)){
...
<div class="title">
        ...
        <form method="post" class="form-horizontal">
            ...
            <div class="form-group">
            	...
            	<div class="col-sm-6">
            	<input type="text" class="form-control" name="txt_uid" value="<?php echo $id;?>" disabled/>
            	</div>
            </div>
            ...
            <div class="col-sm-6">
            	<button type="submit" class="button" name="btn-modify">
                	<i class="glyphicon glyphicon-open-file"></i>수정
                </button>
            </div>
            </div>
        </form>
